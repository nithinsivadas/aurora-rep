function [data] = convertA2E_v2( fileName1 )
...
A = (q(zdim0,Edim0))*(phi_inv); % [cm^-3 s^-1] Verified with Rees 1989 Fig 3.3.3
data.A=A;
%Plotting A
...
[ne,altitude,t]=pfisr_avg_e_v2('DataFile_2008_1.h5',z(zdim0));
